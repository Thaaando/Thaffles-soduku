...
public class Sudoku
{
	...
	// Sudoku Generator
	public List<List<String>> fillValues()
	{
    ...
    //Format Sudoku into list of containers
    public List<String> formatSudoku() {
        ...
        for(int r = 0; r <3; r++){
            ...
            for(int t = 0; t < 3; t++){
                for(int i = 0; i < 3; i++ ){
                    for(int j = 0; j < 3; j++){
                        result.add(Integer.toString(mat[i + rowOffset][j + colOffset]));
                    }
                }
